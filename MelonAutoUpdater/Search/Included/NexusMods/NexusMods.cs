...
namespace MelonAutoUpdater.Search.Included.NexusMods
{
    internal class NexusMods : MAUSearch
    {
        ...
        internal void WebSocket()
        {
            WebSocket websocket = new WebSocket("wss://sso.nexusmods.com");
            websocket.Open();
            ...
            websocket.MessageReceived += (sender, _msg) =>
            {
